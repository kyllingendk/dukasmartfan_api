"""Implements a client for making a udp connection to the duka devices """
import socket
import threading
import time
...
class DukaClient:
    """Client object for making connection to the devices."""
    ...
    def add_device(
        ...
        """Add a new device. If the device already exist the current one will be returned"""
